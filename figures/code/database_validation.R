...
material_alias <- read.csv("figures/data/PrimeMaterials.csv")
material_hierarchy <- read.csv("figures/data/MaterialsHierarchyLower.csv")
item_alias <- read.csv("figures/data/PrimeItems.csv")
item_hierarchy <- read.csv("figures/data/ITEMSHierarchyLower.csv")
use_case_alias <- read.csv("figures/data/PrimeUnclassifiable.csv")
material_item_relation <- read.csv("figures/data/MaterialItemRelationship.csv")
use_case_item_relation <- read.csv("figures/data/Item_Use_Case.csv")
...
material_alias <- read.csv("data/PrimeMaterials_No_Abbreviations.csv")
...
#Calculate similarity, match alias and material names, clean
