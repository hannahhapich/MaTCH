...
ItemsHierarchy <- read.csv("figures/data/ITEMSHierarchyLower.csv")
MaterialsHierarchy <- read.csv("figures/data/MaterialsHierarchyLower.csv")
...
drinkingwater_morpology <- read.csv("figures/data/drinkingwater_samples_morphology.csv")
river_morphology <- read.csv("figures/data/river_samples_morphology.csv")
drinkingwater_material <- read.csv("figures/data/drinkingwater_samples_material.csv")
river_material <- read.csv("figures/data/river_samples_material.csv")
